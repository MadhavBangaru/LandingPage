package com.example.madhavbangaru.landingpage;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void goToAppStore() {
        String iosUrl = "https://itunes.apple.com/in/app/leos-fortune/id830544402?mt=8";
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(iosUrl)));
    }

    private void goToPlayStore() {
        String appPackageName = "com.leosfortune";
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + appPackageName)));
        } catch (android.content.ActivityNotFoundException notFoundActivity) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.leosfortune")));
        }
    }
}
